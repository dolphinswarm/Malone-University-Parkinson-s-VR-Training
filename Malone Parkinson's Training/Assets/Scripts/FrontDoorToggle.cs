...
public class FrontDoorToggle : MonoBehaviour {

	public Vector3 closeAngle = new Vector3(0f, 0f, 0f); // angle when the door is closed
	public Vector3 openAngle = new Vector3(0f, 90f, 0f); // angle when the door is open
	private bool isClosed = true; // check to see if the door is closed or not
	private Vector3 targetDir; // direction the door will swing
	public float speed = 1.0f; // the speed at which the door with move
