...
public class BendingSegment {
	public Transform firstTransform; // The first object's transform
	public Transform lastTransform; // The last object's transform
...
public class HeadLookControllerModified : MonoBehaviour {
	
	public Transform rootNode;
    public bool isInTrigger; // only looks at the object if its in the trigger zone
	public BendingSegment[] segments;
	public NonAffectedJoints[] nonAffectedJoints;
	public Vector3 headLookVector = Vector3.forward;
	public Vector3 headUpVector = Vector3.up;
	public Vector3 target = Vector3.zero; // Passed in from the cursorHit method
    public Vector3 targetDefault = Vector3.zero; // Passed in from the cursorHit method
    ...
    void LateUpdate() {
        ...
        //checks if the object is in the trigger zone
        if (isInTrigger)
        {
        ...
        else
        {
            ...
            foreach (BendingSegment segment in segments)
            {
                ...
                // Desired look direction in world space
                Vector3 lookDirWorld = (targetDefault - segment.lastTransform.position).normalized;
        ...
        //else statement that returns it to its default position
